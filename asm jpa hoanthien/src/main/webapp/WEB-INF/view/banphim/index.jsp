...
<div class="container">
    ...
    <section>
        ...
        <form action="/banphim/findthuoctinh">
            ...
            <c:url var="pageUrl" value="/banphim">
    ...
    <c:if test="${dsBanPhim.isEmpty()}">
        <h5 class="alert alert-danger text-center">Empty list you have</h5>
    </c:if>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <c:if test="${dsBanPhim.number+1>1}">
                    <li class="page-item">
                        <a class="page-link" href="?page=${dsBanPhim.number}" aria-label="Previous">
                ...
                <c:forEach items="${tongSoTrang}" varStatus="y">
                    <c:if test="${dsBanPhim.number==y.index}">
                        <li class="page-item active">
                            <a class="page-link" href="?page=${y.index+1}">${y.index+1}</a>
                        </li>
                    </c:if>
                    <c:if test="${dsBanPhim.number!=y.index}">
                        <li class="page-item">
                ...
                <c:if test="${dsBanPhim.getNumber() + 1 lt dsBanPhim.getTotalPages()}">
                    <a class="page-link" aria-label="Next" href="?page=${dsBanPhim.getNumber() + 2}">
